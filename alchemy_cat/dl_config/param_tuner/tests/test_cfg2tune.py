...
sys.path = ['', 'dl_config/param_tuner/tests'] + sys.path  # noqa: E402

from alchemy_cat.dl_config import Cfg2Tune, open_config, ItemLazy, Config
...
def test_same_name_config():
    with pytest.raises(RuntimeError, match="for param2tune repeated."):
        Cfg2Tune.load_cfg2tune(osp.join('dl_config/param_tuner/tests', 'configs', 'same_name_config', 'cfg.py'))
