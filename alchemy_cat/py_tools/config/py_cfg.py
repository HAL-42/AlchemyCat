...
"""
    ...
    def _save_cfg_for_other_cfg_system(self) -> dict:
        ...
        saved_cfg.update_at_parser()
        return saved_cfg.to_dict()

    def save_yaml(self, file: Union[str, os.PathLike]) -> None:
        import yaml
        Path(file).write_text(yaml.dump(self._save_cfg_for_other_cfg_system()))

    def save_mmcv(self, file: Union[str, os.PathLike]) -> None:
